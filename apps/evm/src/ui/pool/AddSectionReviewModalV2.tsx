...
interface AddSectionReviewModalV2Props {
...
export const AddSectionReviewModalV2: FC<AddSectionReviewModalV2Props> = ({
  poolAddress,
  poolState,
  chainId,
  token0,
  ...
  const { approved } = useApproved(APPROVE_TAG_ADD_V2)
