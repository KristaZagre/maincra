    ...
    <>
      <CardHeader>
        <CardTitle>
          ...
          <span className="ml-1 text-sm font-normal text-muted-foreground">
            ...
            {incentives.length > 0 ? `+ ${formatPercent(incentiveApr)} rewards` : ''}
          </span>
        </CardTitle>
        <CardDescription className="text-xs font-normal">
          APR is calculated based on the fees{incentives.length > 0 ? ' and rewards' : ''} generated by the pool over
          the last 24 hours. <b>The APR displayed is algorithmic and subject to change.</b>
        </CardDescription>
      </CardHeader>
      {incentives.length > 0 && showEmissions ? (
        <CardContent>
          <Reply>
            <ReplyContent>
              <p className="mb-1 text-xs text-muted-foreground">Reward emissions (per day)</p>
